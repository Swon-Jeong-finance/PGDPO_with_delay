...
import json
import numpy as np
from p1_oracle import (ORACLE_API_VERSION, build_dense, riccati,
                       detached_curvature, exact_recovery_inputs)
from p1_common import V3, T_MAIN, DELTA_MAIN, H_MAIN, grid as make_grid, \
                      make_hist, feedback_path
...
if __name__ == "__main__":
    ...
    params = dict(V3)                       # adopted P1-U calibration
    T, delta, h = T_MAIN, DELTA_MAIN, H_MAIN
    N, H, tt = make_grid(T, delta, h); n = H+1
