...
import csv
import numpy as np
from p1_oracle import ORACLE_API_VERSION, riccati, detached_curvature, exact_recovery_inputs
from p1_common import V3, grid, make_hist, feedback_path
...
for h in (0.1, 1/15, 0.05, 0.025, 0.0125, 0.00625):
