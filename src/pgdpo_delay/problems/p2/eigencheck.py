...
"""
import numpy as np
from .oracle import P2_API_VERSION, kernel_weights, mode_spec, p2_mode_oracle, \
...
def run_check():
    ...
    for nm, vv in dict(P=eP, G=eG, s=es, c=ec, Lam=eL, u=eu, foc_m=efoc_m,
                       foc_d=efoc_d, anc=eanc).items():
        assert vv < 1e-10, (nm, vv)
